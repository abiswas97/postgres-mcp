...
const TOOL_DEFINITIONS = [
  { name: 'query', description: 'Execute SQL with pagination and parameterization', schemaKey: 'query' },
  { name: 'describe_table', description: 'Get table structure including columns, constraints, and size statistics', schemaKey: 'describe_table' },
  { name: 'list_objects', description: 'List tables, views, or functions in a schema', schemaKey: 'list_objects' },
  { name: 'list_schemas', description: 'List all schemas in the database', schemaKey: 'list_schemas' },
  { name: 'list_indexes', description: 'List indexes for a table or schema', schemaKey: 'list_indexes' },
  { name: 'explain_query', description: 'Get query execution plan (EXPLAIN)', schemaKey: 'explain_query' },
  { name: 'search_objects', description: 'Find tables, columns, functions, views by name pattern across schemas', schemaKey: 'search_objects' },
  { name: 'get_connections', description: 'Show active database connections, utilization, and idle-in-transaction warnings', schemaKey: 'get_connections' },
  { name: 'diagnose_database', description: 'Composite database health check: cache, connections, vacuum, indexes, sequences', schemaKey: 'diagnose_database' },
  { name: 'get_slow_queries', description: 'Analyze slow queries via pg_stat_statements with filtering and sorting', schemaKey: 'get_slow_queries' },
];
...
describe('MCP Protocol Handler', () => {
  ...
  describe('CallTool routing', () => {
    ...
    test.each(toolInputs)(
      '%s routes correctly and returns mock result',
      async (toolName, args) => {
